...
# When enabled, run a short 3-day simulation and seed selected vessels
# as full-load arrivals at Point B at t=0.
POINT_B_DISTRIBUTION_TEST_MODE = True
...
STARTUP_DAY_POINT_B_MANUAL_NOMINATIONS = {
    # Day-1 manual nominations for startup exception logic.
    "Sherlock": MOTHER_PRIMARY_NAME,
    "Laphroaig": MOTHER_SECONDARY_NAME,
    "Watson": MOTHER_TERTIARY_NAME,
}
