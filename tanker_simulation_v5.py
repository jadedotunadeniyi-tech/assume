            ...
            for v in self.vessels:
                ...
                if v.status == "IDLE_A":
                    ...
                    if not candidates:
                        ...
                        # Same-day hard spread rule:
                        # 1) First daughter arrival on a day takes the first eligible mother.
                        ...
                        # First eligible mother follows configured mother order.
                        # Enforce same-day uniqueness by excluding mothers already assigned today.
                        available_distinct = [
                        ...
                        assigned_today.add(selected_mother)
