...
def chart_util(tl_df):
    items = [("Chapel","Chapel_bbl",270_000),("JasmineS","JasmineS_bbl",290_000),
             ...
             ("Starturn","Starturn_bbl",70_000),("PGM","PGM_bbl",30_000)]
    fig = go.Figure()
...
""")
    ...
    if not gs_vols:
        with st.expander("✏️ Enter 08:00 storage & mother volumes",
            ...
            for j,(sn,cv) in enumerate([
                ...
                ("Duke",90_000),("Starturn",70_000),("PGM",30_000)
            ]):
                with sv[j]:
    ...
    params = dict(
        ...
        pgm       = _p("pgm",       manual_storage, "PGM",      SCAP.get("PGM", 30_000)//2),
...
Generated {_dt.datetime.now().strftime('%Y-%m-%d %H:%M')} | Tanker Operations Simulation v5
    ...
    _capacities  = {"Chapel":270_000,"JasmineS":290_000,"Westmore":270_000,"Duke":90_000,"Starturn":70_000,"PGM":30_000}
...
<div class="summary-card">
  ...
  <ul>
    ...
    st_info = [
        ...
        ("PGM","PGM_bbl","PGM_Overflow_Accum_bbl",30_000,"G",sorted(getattr(mod,"PGM_PERMITTED_VESSELS",{"SantaMonica"}))),
    ]
  ...
  .jmp-bia-entry{display:inline-block;border-radius:4px;padding:2px 6px;
    ...
    for _day in range(_jmp_d0, _jmp_d1 + 1):
        ...
        _STOCK_THRESHOLDS = {
            ...
            "PGM":       ( 21_000,  25_200),   # proportional: ~70% & ~84% of 30k
        }
        def _scell(name):
