...
def main():
    ...
    with st.sidebar:
        ...
        enable_point_b_startup_seed = st.toggle(
            "Validation Seed: Sherlock/Laphroaig/Watson full-load at BIA",
            value=False,
            help=(
                "When enabled, these vessels start at t=0 in HOSE_CONNECT_B with full cargo: "
                "Sherlock->Bryanston, Laphroaig->Alkebulan, Watson->GreenEagle."
            ),
